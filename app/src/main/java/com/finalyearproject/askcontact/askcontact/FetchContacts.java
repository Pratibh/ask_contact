...
public class FetchContacts extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // outputText = (TextView) findViewById(R.id.textView1);
        fetchContacts(getApplicationContext());
    }

    public List<Person> fetchContacts(Context context) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (hasPhoneNumber > 0) {
                    ...
                    Cursor phoneCursor = contentResolver.query(PhoneCONTENT_URI,
                            null, Phone_CONTACT_ID + " = ?", new String[] { contact_id }, null);
